...
class TransformerMSOcc(BaseModule):
    ...
    def get_occ_features(
            ...
            **kwargs):
        """
        obtain occ features. # enhance [50, 50, 16] occ features
        """
    ...
    @auto_fp16(apply_to=('mlvl_feats', 'occ_queries', 'occ_pos'))
    def forward(self,
                mlvl_feats,
                occ_queries,
                occ_x,
        ...
        occ_embed = self.get_occ_features(
            ...
            occ_pos=occ_pos,
            prev_occ=prev_occ,
            **kwargs)  # occ_embed shape: bs, occ_x*bev_w*occ_z, embed_dims
